...
public class SnowFlakeIdUtil {
	private final static Logger logger = LoggerFactory.getLogger(SnowFlakeIdUtil.class);
	...
	private static SnowFlakeIdUtil flowIdWorker = new SnowFlakeIdUtil(RandomUtils.nextInt(0,1000));

	public static SnowFlakeIdUtil getFlowIdWorkerInstance() {
		return flowIdWorker;
	}
	...
	public static void main(String[] args) {
		...
		SnowFlakeIdUtil snowFlakeIdWorker = SnowFlakeIdUtil.getFlowIdWorkerInstance();
//		System.out.println(Long.toBinaryString(snowFlakeIdWorker.nextId()));
		System.out.println(SnowFlakeIdUtil.getFlowIdWorkerInstance().nextId());
